...
/* package projeto-tipo-chronon-0.1.0.0 */
#ifndef VERSION_projeto_tipo_chronon
#define VERSION_projeto_tipo_chronon "0.1.0.0"
#endif /* VERSION_projeto_tipo_chronon */
#ifndef MIN_VERSION_projeto_tipo_chronon
#define MIN_VERSION_projeto_tipo_chronon(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projeto_tipo_chronon */
...
#define CURRENT_COMPONENT_ID "projeto-tipo-chronon-0.1.0.0-AbMABzaVwH39v69GyRNhYF-projeto-tipo-chronon"
