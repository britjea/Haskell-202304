...
/* package projeto-tipocalculadora-0.1.0.0 */
#ifndef VERSION_projeto_tipocalculadora
#define VERSION_projeto_tipocalculadora "0.1.0.0"
#endif /* VERSION_projeto_tipocalculadora */
#ifndef MIN_VERSION_projeto_tipocalculadora
#define MIN_VERSION_projeto_tipocalculadora(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projeto_tipocalculadora */
...
#define CURRENT_COMPONENT_ID "projeto-tipocalculadora-0.1.0.0-FeBiCPINnJ29Bq9SHl8tsh-projeto-tipocalculadora"
