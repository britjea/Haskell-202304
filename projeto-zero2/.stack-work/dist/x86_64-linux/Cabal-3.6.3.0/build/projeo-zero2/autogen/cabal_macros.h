...
/* package projeo-zero2-0.1.0.0 */
#ifndef VERSION_projeo_zero2
#define VERSION_projeo_zero2 "0.1.0.0"
#endif /* VERSION_projeo_zero2 */
#ifndef MIN_VERSION_projeo_zero2
#define MIN_VERSION_projeo_zero2(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projeo_zero2 */
...
/* package vector-sized-1.5.0 */
#ifndef VERSION_vector_sized
#define VERSION_vector_sized "1.5.0"
...
#define CURRENT_COMPONENT_ID "projeo-zero2-0.1.0.0-JWT4iQsI7YBJcCSSNMc8UK-projeo-zero2"
