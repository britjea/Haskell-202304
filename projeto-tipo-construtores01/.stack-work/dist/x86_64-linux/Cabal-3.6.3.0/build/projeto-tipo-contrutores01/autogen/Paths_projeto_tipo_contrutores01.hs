...
{-# OPTIONS_GHC -w #-}
module Paths_projeto_tipo_contrutores01 (
    version,
...
getDynLibDir  = catchIO (getEnv "projeto_tipo_contrutores01_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "projeto_tipo_contrutores01_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "projeto_tipo_contrutores01_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "projeto_tipo_contrutores01_sysconfdir") (\_ -> return sysconfdir)
