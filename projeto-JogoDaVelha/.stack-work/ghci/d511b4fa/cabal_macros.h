...
/* package projeto-JogoDaVelha-0.1.0.0 */
#ifndef VERSION_projeto_JogoDaVelha
#define VERSION_projeto_JogoDaVelha "0.1.0.0"
#endif /* VERSION_projeto_JogoDaVelha */
#ifndef MIN_VERSION_projeto_JogoDaVelha
#define MIN_VERSION_projeto_JogoDaVelha(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projeto_JogoDaVelha */
...
#define CURRENT_COMPONENT_ID "projeto-JogoDaVelha-0.1.0.0-4Rc9e0ct7GvCiOLypqc3Yi-projeto-JogoDaVelha"
