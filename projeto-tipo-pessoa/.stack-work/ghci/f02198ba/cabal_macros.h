...
/* package projeto-tipo-pessoa-0.1.0.0 */
#ifndef VERSION_projeto_tipo_pessoa
#define VERSION_projeto_tipo_pessoa "0.1.0.0"
#endif /* VERSION_projeto_tipo_pessoa */
#ifndef MIN_VERSION_projeto_tipo_pessoa
#define MIN_VERSION_projeto_tipo_pessoa(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projeto_tipo_pessoa */
...
#define CURRENT_COMPONENT_ID "projeto-tipo-pessoa-0.1.0.0-EwUNN3QcWtaJlu6dNLwhBH-projeto-tipo-pessoa"
